...
function mantenedora_create_post_type() { 
	...
	register_post_type( 'como-ajudar', array(
		'labels' 		=> array( 'name' => 'Como ajudar', 'singular_name' => 'Como ajudar', 'all_items' => 'Todos' ),
		'public' 		=> true,
		'has_archive'	=> true,
	...
	register_post_type( 'benfeitores', array(
		'labels' 		=> array( 'name' => 'Benfeitores', 'singular_name' => 'Benfeitores', 'all_items' => 'Todos' ),
		'public' 		=> true,
		'has_archive'	=> true,
		'menu_icon'		=> 'dashicons-book',
		'supports' 		=> array( 'title', 'thumbnail' ), 
...
function mantenedora_create_page() {
	...
	if( function_exists('acf_add_options_page') ) {	
        ...
        acf_add_options_page( 
            array( 
                'page_title' => 'Nossas Obras', 
                'menu_title' => 'Nossas Obras', 
                'menu_slug'  => 'nossas_obras', 
                'capability' => 'edit_posts', 
                'position'   => '23,4', 
                'redirect'   => false, 
