...
<?php if(!is_page_template( 'blank-page.php' ) && !is_page_template( 'blank-page-with-container.php' )): ?>
    ...
    <footer class="l-footer u-bg-folk-secondary mt-5">
                        ...
                        <div class="col-md-5 order-3 order-md-1 mt-3 mt-md-0">
                            ...
                            <div class="row justify-content-md-end">
                                ...
                                <div class="col-md-9 mb-3 mr-md-5">
                                    <h3 class="c-title d-block u-font-weight-bold text-center text-uppercase u-color-folk-white u-bg-folk-primary py-3 px-4">
                                            ...
                                            <ul class="l-top__social-media d-flex justify-content-center mb-0 pl-0">
                                                ...
                                                <?php if(get_field( 'instagram', 'option' )) : ?>
                                                    <li class="l-top__social-media__item d-flex justify-content-center align-items-center u-bg-folk-white mx-1">
                                                        <a 
                                                        class="u-icon__brands u-icon__instagram u-font-size-0 before::u-font-size-20 text-decoration-none u-color-folk-secondary" 
                                                ...
                                                <?php if(get_field( 'facebook', 'option' )) : ?>
                                                    <li class="l-top__social-media__item d-flex justify-content-center align-items-center u-bg-folk-white mx-1">
                                                        <a 
                                                        class="u-icon__brands u-icon__facebook u-font-size-0 before::u-font-size-20 text-decoration-none u-color-folk-secondary" 
                                                ...
                                                <?php if(get_field( 'youtube', 'option' )) : ?>
                                                    <li class="l-top__social-media__item d-flex justify-content-center align-items-center u-bg-folk-white mx-1">
                                                        <a 
                                                        class="u-icon__brands u-icon__youtube u-font-size-0 before::u-font-size-20 text-decoration-none u-color-folk-secondary" 
                                                ...
                                                <?php if(get_field( 'whatsapp', 'option' )) : ?>
                                                    <li class="l-top__social-media__item d-flex justify-content-center align-items-center u-bg-folk-white mx-1">
                                                        <a 
                                                        class="u-icon__brands u-icon__whatsapp u-font-size-0 before::u-font-size-20 text-decoration-none u-color-folk-secondary" 
