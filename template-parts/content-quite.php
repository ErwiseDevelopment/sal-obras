    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 px-0">
                ...
                <img
                class="img-fluid"
                src="<?php echo get_field( 'banner_meio' ) ?>"
                alt="Meio">
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 mt-5 mt-lg-n4">
                ...
                <div class="row justify-content-center">
                    ...
                    <?php if(have_rows( 'meio' )) : 
                            while(have_rows( 'meio' )) : the_row();
                    ?>
                                <div class="col-12 l-mvv__col-child my-3 my-md-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 l-mvv__item-child">
                                            ...
                                            src="<?php echo get_sub_field( 'img_destacada' ) ?>"
                                            alt="<?php echo get_sub_field( 'titulomeio' ) ?>"
                                            data-aos="zoom-in"
                                        ...
                                        <div class="col-md-6 l-mvv__item-child d-flex flex-column justify-content-center mt-3 mt-md-0">
                                            <h5 class="l-mvv__title u-font-weight-black text-uppercase">
                                                ...
                                                <span class="l-mvv__title-child"><?php echo get_sub_field( 'titulomeio' ) ?></span>
                                            </h5>
